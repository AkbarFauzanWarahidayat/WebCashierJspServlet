 ...
 * @author ASUS
 */
@WebServlet(name = "stokBarangTambahServlet", urlPatterns = {"/stokBarangTambahServlet"})
public class stokBarangTambahServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            pst = koneksi.prepareStatement("INSERT INTO stok_barang(kd_barang, nama_barang, qty, harga_satuan, id_supplier) VALUES(?,?,?,?,?)");
